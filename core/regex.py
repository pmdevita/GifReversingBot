...
class REPatterns:
    ...
    # Gfycat
    gfycat = re.compile("^http(?:s)?://(?:\w+?\.)?gfycat\.com/(?:gifs/detail/|)(.*?)(?:|-.*|\..*|/.*)$")
...
if __name__ == '__main__':
    print(REPatterns.link.findall("[https://gfycat.com/Pass  ionateTenseAmurratsnake](https://gfycat.com/PassionateTenseAmurratsnake) "
                                  ""
                                  "[https://gfycat.com/PassionateTenseAmurratsnake](https://gfycat.com/PassionateTenseAmurratsnake)"))